...
function useSize(element) {
  const [size2, setSize] = React25.useState(void 0);
  useLayoutEffect23(() => {
    if (element) {
...
var PopperContent = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React26.useState(null);
...
function useComposedRefs2(...refs) {
  return React31.useCallback(composeRefs3(...refs), refs);
}
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React32.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime16.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React32.isValidElement(newElement) ? React32.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable3(child) {
  return React32.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER3;
}
...
function createCollection2(name) {
  const PROVIDER_NAME = name + "CollectionProvider";
  const [createCollectionContext, createCollectionScope3] = createContextScope3(PROVIDER_NAME);
  const [CollectionProviderImpl, useCollectionContext] = createCollectionContext(
    PROVIDER_NAME,
    { collectionRef: { current: null }, itemMap: /* @__PURE__ */ new Map() }
  );
  ...
  const CollectionSlot = import_react3.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return (0, import_jsx_runtime17.jsx)(CollectionSlotImpl, { ref: composedRefs, children });
    }
  );
  CollectionSlot.displayName = COLLECTION_SLOT_NAME;
  const ITEM_SLOT_NAME = name + "CollectionItemSlot";
  ...
  const CollectionItemSlot = import_react3.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return (0, import_jsx_runtime17.jsx)(CollectionItemSlotImpl, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
    }
  );
  CollectionItemSlot.displayName = ITEM_SLOT_NAME;
  function useCollection3(scope) {
...
var useInsertionEffect2 = React38[" useInsertionEffect ".trim().toString()] || useLayoutEffect24;
function useControllableState2({
  ...
  const value = isControlled ? prop : uncontrolledProp;
  if (true) {
    const isControlledRef = React38.useRef(prop !== void 0);
    React38.useEffect(() => {
      const wasControlled = isControlledRef.current;
      if (wasControlled !== isControlled) {
        const from = wasControlled ? "controlled" : "uncontrolled";
...
function useUncontrolledState2({
  ...
  const [value, setValue] = React38.useState(defaultProp);
  const prevValueRef = React38.useRef(value);
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? React40.useLayoutEffect : React40.useEffect;
...
var useReactId3 = React50[" useId ".trim().toString()] || (() => void 0);
var count4 = 0;
function useId3(deterministicId) {
  const [id, setId] = React50.useState(useReactId3());
  useLayoutEffect2(() => {
